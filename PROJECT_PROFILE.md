...
> Основний матеріал мембран — натуральна козяча шкура різних порід, віку та статі тварини. Саме ці особливості впливають на характер мембрани й звук. Іноді використовую оленячу шкіру або матеріал, який надіслав замовник.

Дерево для обода:

> Для обода найчастіше використовую ясен; іноді березу або бук. Ясен міцний, пружний і музичний матеріал, тому добре тримає форму та звучання бубна.

Догляд:

> Креми та мазі на основі воску добре підходять для догляду за мембраною: віск заповнює пори, і з часом вологість менше впливає на натяг шкіри та звук.
